/**
 * ===== NEXUS MODERN NOTIFICATION SYSTEM =====
 *
 * Elegant notification system with glassmorphism design, smooth animations,
 * and comprehensive mobile optimizations. Provides toast notifications and
 * confirmation dialogs with advanced event handling and user experience features.
 *
 * CORE FEATURES:
 ...
 * - Event delegation for optimal performance and reliability
 * - Single notification display with automatic replacement
 * - Confirmation dialogs with proper callback handling
 *
 * DESIGN PRINCIPLES:
 * - Clean, minimal interface without distracting hover animations
 * - Responsive design that adapts to mobile, tablet, and landscape orientations
 * - Accessibility-compliant with proper ARIA attributes and touch targets
 * - Performance-optimized with efficient event handling and DOM manipulation
 *
 * NOTIFICATION TYPES:
 * - Success: Green checkmark for positive actions
 * - Error: Red X for error states and failures
 * - Info: Blue info icon for informational messages
 * - Warning: Orange triangle for warnings and cautions
 * - Confirmation: Interactive dialog with confirm/cancel buttons
 *
...
class NotificationSystem {
    ...
    createConfirmation(id, title, message, onConfirm, onCancel) {
        ...
        // ===== INTERACTIVE CONFIRMATION STRUCTURE =====
        notification.innerHTML = `
            <div class="notification-content">
                <div class="notification-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="notification-body">
                    ...
                    <div class="notification-actions">
                        <button class="notification-btn notification-btn-cancel" data-action="cancel" data-id="${id}">
                            Cancel
                        </button>
                        <button class="notification-btn notification-btn-confirm" data-action="confirm" data-id="${id}">
                            Reset
                        </button>
                    </div>
                </div>
